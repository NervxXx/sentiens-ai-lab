      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <h2 className="font-orbitron text-3xl md:text-5xl lg:text-6xl font-bold mb-6">
            <AnimatedGradientText text="Движок Sentiens" delay={0.2} />
          </h2>
        ...
        >
          <p className="font-inter text-center text-muted-foreground leading-relaxed max-w-4xl mx-auto">
            Наша разработка <span className="text-primary font-semibold">это продуманная архитектура</span>, которая превращает языковые модели (LLM) в более способных и полезных агентов. Мы добавляем им память о прошлых взаимодействиях, способность ставить цели в рамках задачи и уникальные черты характера. <span className="text-neon-green font-semibold">Наша цель — выйти за рамки простого чата.</span>
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="font-inter text-muted-foreground text-center max-w-3xl mx-auto leading-relaxed">
            Мы строим на передовых LLM (OpenAI GPT, Anthropic Claude, DeepSeek, open-source решения), но наша ценность — в слоях агентной логики, продвинутой инженерии промптов (prompt/AGI chaining) и системе оркестрации, которые являются <span className="text-primary">нашей интеллектуальной собственностью</span>.
          </p>
        </motion.div>
